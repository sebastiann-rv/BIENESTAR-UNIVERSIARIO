<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmPastorial.aspx.cs" Inherits="BIENESTAR_UNIVERSITARIO.frmcultural" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table class="auto-style1">
                <tr>
                    <td class="auto-style3">CODIGO DE PASTORIAL</td>
                    <td class="auto-style4">
                        <asp:TextBox ID="txtpastorial" runat="server"></asp:TextBox>
                    </td>
                    <td class="auto-style5">
                        <asp:Button ID="btnpastorial" runat="server" Text="BUSCAR PASTORIAL" />
                    </td>
                </tr>
                <tr>
