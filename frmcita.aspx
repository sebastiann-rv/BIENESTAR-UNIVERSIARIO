<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmcita.aspx.cs" Inherits="BIENESTAR_UNIVERSITARIO.frmcitas" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table class="auto-style1">
                <tr>
                    <td class="auto-style5">CODIGO DE CITA</td>
                    <td>
                        <asp:TextBox ID="txtcita" runat="server"></asp:TextBox>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
                    <td>
                        <asp:Button ID="btncita" runat="server" Text="BUSCAR CITA" OnClick="btncita_Click" />
                    </td>
                </tr>
                <tr>
