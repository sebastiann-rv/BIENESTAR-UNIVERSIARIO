<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmrecreacion.aspx.cs" Inherits="BIENESTAR_UNIVERSITARIO.frmcultural" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table class="auto-style1">
                <tr>
                    <td class="auto-style3">CODIGO DE RECREACIÓN</td>
                ...
                <tr>
                    <td class="auto-style3">IDENTIFICACIÓN&nbsp; USUARIO&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:TextBox ID="txtusuario" runat="server" Enabled="False" Width="179px"></asp:TextBox>
                    </td>
                    <td class="auto-style4">&nbsp;&nbsp;
